    ...
    <div className="flex items-center justify-center me-12">
      ...
      >
        <div className="md:relative ms-12" style={{ width: "500px" }}>
          ...
          >
            <p className="text-center font-bold text-black">One Heart Team</p>
          </div>
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-6 p-6 bg-white">
            {/* Images from API */}
